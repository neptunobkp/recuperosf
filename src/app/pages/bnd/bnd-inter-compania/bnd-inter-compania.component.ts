...
@Component({
  selector: "app-bnd-inter-compania",
  templateUrl: "./bnd-inter-compania.component.html",
  styleUrls: ["./bnd-inter-compania.component.scss"],
})
export class BndInterCompaniaComponent implements AfterViewInit {
  etapa: string = "Intercompañía";
  etapaId: number = 22;
  estados: Task[];
  editarForm: any;
