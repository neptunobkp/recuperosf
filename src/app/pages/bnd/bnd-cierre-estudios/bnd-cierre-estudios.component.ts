...
@Component({
  selector: "app-bnd-cierre-estudios",
  templateUrl: "./bnd-cierre-estudios.component.html",
  styleUrls: ["./bnd-cierre-estudios.component.scss"],
})
export class BndCierreEstudiosComponent implements AfterViewInit {
  etapa: string = "Cierre Estudios";
  etapaId: number = 28;
  estados: Task[];
  ejecutivos: any[];
  editarForm: any;
