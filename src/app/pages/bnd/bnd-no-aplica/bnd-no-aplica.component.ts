...
@Component({
  selector: "app-bnd-no-aplica",
  templateUrl: "./bnd-no-aplica.component.html",
  styleUrls: ["./bnd-no-aplica.component.scss"],
})
export class BndNoAplicaComponent implements AfterViewInit {
  etapa: string = "AnaNo Aplicalisis";
  etapaId: number = 30;
  estados: Task[];
  editarForm: any;
