...
@Component({
  selector: "app-bnd-estudios-juridicos",
  templateUrl: "./bnd-estudios-juridicos.component.html",
  styleUrls: ["./bnd-estudios-juridicos.component.scss"],
})
export class BndEstudiosJuridicosComponent implements AfterViewInit {
  etapa: string = "Estudios Jurídicos";
  etapaId: number = 27;
  estados: Task[];
  ejecutivos: any[];
  editarForm: any;
