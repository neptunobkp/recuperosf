...
@Component({
  selector: "app-bnd-carta-intercompania",
  templateUrl: "./bnd-carta-intercompania.component.html",
  styleUrls: ["./bnd-carta-intercompania.component.scss"],
})
export class BndCartaIntercompaniaComponent implements AfterViewInit {
  etapa: string = "Carta Intercompañía";
  etapaId: number = 24;
  estados: Task[];
  editarForm: any;
