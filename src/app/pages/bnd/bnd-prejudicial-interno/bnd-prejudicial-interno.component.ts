...
@Component({
  selector: "app-bnd-prejudicial-interno",
  templateUrl: "./bnd-prejudicial-interno.component.html",
  styleUrls: ["./bnd-prejudicial-interno.component.scss"],
})
export class BndPrejudicialInternoComponent implements AfterViewInit {
  etapa: string = "Pre-Judicial Interno";
  etapaId: number = 25;
  currentUser: User;
...
onSaveForm() {
  ...
  ngAfterViewInit() {
    ...
    this.taskService
      .getUsuarios("PrejudicialInterno")
