...
@Component({
  selector: "app-bnd-recuperados",
  templateUrl: "./bnd-recuperados.component.html",
  styleUrls: ["./bnd-recuperados.component.scss"],
})
export class BndRecuperadosComponent implements AfterViewInit {
  etapa: string = "Recuperados";
  etapaId: number = 29;
  estados: Task[];
  editarForm: any;
