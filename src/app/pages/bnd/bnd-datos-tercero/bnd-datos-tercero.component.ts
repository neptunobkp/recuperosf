...
@Component({
  selector: "app-bnd-datos-tercero",
  templateUrl: "./bnd-datos-tercero.component.html",
  styleUrls: ["./bnd-datos-tercero.component.scss"],
})
export class BndDatosTerceroComponent implements AfterViewInit {
  etapa: string = "Datos Tercero";
  etapaId: number = 19;
  estados: Task[];
