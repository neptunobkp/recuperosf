...
@Component({
  selector: "app-bnd-asignacion-judicial",
  templateUrl: "./bnd-asignacion-judicial.component.html",
  styleUrls: ["./bnd-asignacion-judicial.component.scss"],
})
export class BndAsignacionJudicialComponent implements AfterViewInit {
  etapa: string = "Asignación Judicial";
  etapaId: number = 26;
  currentUser: User;
