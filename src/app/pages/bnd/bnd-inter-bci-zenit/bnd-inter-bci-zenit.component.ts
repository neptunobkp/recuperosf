...
@Component({
  selector: "app-bnd-inter-bci-zenit",
  templateUrl: "./bnd-inter-bci-zenit.component.html",
  styleUrls: ["./bnd-inter-bci-zenit.component.scss"],
})
export class BndInterBciZenitComponent implements AfterViewInit {
  etapa: string = "Intercompañía BCI/Zenit";
  etapaId: number = 23;
  estados: Task[];
  editarForm: any;
  ...
  otrasCompanias = [
    { valor: "BCI", texto: "Bci Seguros" },
    { valor: "ZEN", texto: "Zenit Seguros" },
  ];
