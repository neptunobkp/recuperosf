...
@Component({
  selector: "app-bnd-consulta-siniestro",
  templateUrl: "./bnd-consulta-siniestro.component.html",
  styleUrls: ["./bnd-consulta-siniestro.component.scss"],
})
export class BndConsultaSiniestroComponent implements AfterViewInit {
  etapa: string = "Consulta Siniestros";
  etapaId: number = -1;
  estados: Task[];
  editarForm: any;
