...
export class TransicionesComponent implements OnInit {
  ...
  guardar() {
    ...
    const payload = {
      estadoOrigenId: Number(this.estadoId),
      estadosDestinoId: estadosSeleccionados,
    };

    this.taskService.postTransiciones(this.estadoId, payload).subscribe(() => {
